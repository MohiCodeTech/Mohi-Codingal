...
# label1 = Label(root, 
#                text="Hello user, Would you like to start the denomination calculator?"
#                , bg="light blue")
...
#     label = Label(top, text="Enter your amount", bg="Light gray")
#     entry = Entry(top)
#     lbl = Label(top, text="These are all the notes in the denomination calculator", bg="Light grey")
...
# def msg():
#     Msgbox = messagebox.showinfo("Would you like to start denomination", "Press ok if u like to start it")
#     if Msgbox == "ok":
#         Topwin()
