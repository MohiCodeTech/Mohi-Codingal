...
--       ('3005', 'Graham Suzi', 'California', 200, '5002'),
--       ('3008', 'Julian Green', 'London', 300, '5002'),
--       ('3004', 'Fabilion Johnson', 'Paris', 300, '5006'),
...
-- -- Match customer and salseman by city
-- SELECT Customer.cust_name, Salesman.name, Salesman.city
-- FROM Customer
-- JOIN Salesman ON Customer_city = Salesman_city;

-- -- Link cust to their salesamn
-- SELECT Customer.cust_name, Salesman.name
-- FROM Customer
-- JOIN Salesman ON Customer.Salesman_id = Salesman.Salesman_id;

-- -- Get order where cust city is not salesman city
...
-- JOIN Salesman ON Orders.salesman_id = Salesman.Salesman_id
-- JOIN Customer ON Orders.customer_id = Customer.customer_id
-- WHERE Customer_grade IS NOT NULL
